...
class TestGitOperations(unittest.TestCase):
    ...
    def test_git_commit_with_issue_reference(self, mock_run):
        ...
        self.assertIn('Closes #123', kwargs.get('input', ''))
    ...
    def test_git_commit_with_multiple_changes(self, mock_run):
        ...
        mock_run.assert_called_once()
        args, kwargs = mock_run.call_args
        commit_message = kwargs.get('input', '')
        self.assertIn('- Added toggle switch component', commit_message)
        self.assertIn('- Implemented theme switching logic', commit_message)
        self.assertIn('- Added local storage persistence', commit_message)
