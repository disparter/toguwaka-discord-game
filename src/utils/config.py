...
DYNAMODB_STORY_TABLE = os.getenv('DYNAMODB_STORY_TABLE', 'Historia')
DYNAMODB_COOLDOWNS_TABLE = os.getenv('DYNAMODB_COOLDOWNS_TABLE', 'Cooldowns')
DYNAMODB_SYSTEM_FLAGS_TABLE = os.getenv('DYNAMODB_SYSTEM_FLAGS_TABLE', 'SystemFlags')
